  ...
  return (
    <div className="bg-white">
      <style>{`
        ...
        .gradient-animated {
          background: linear-gradient(270deg, #fb7185, #f472b6, #a855f7, #f472b6);
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-purple-100 px-4 py-2 rounded-full mb-6 fade-up">
                <RotateCw size={18} className="text-purple-900" />
                <span className="text-sm font-semibold text-purple-900">Dialer Solution</span>
              </div>
      ...
      {/* Dialing Modes */}
      <section className="py-24 px-6 bg-gradient-to-b from-rose-50 via-white to-fuchsia-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Multiple Dialing Modes</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={idx} className="bg-white/90 backdrop-blur rounded-2xl p-8 border border-rose-200 shadow-[0_20px_50px_rgba(244,63,94,0.18)] hover:-translate-y-1 hover:shadow-[0_30px_70px_rgba(217,70,239,0.25)] transition-all">
                <div className="bg-rose-700 w-16 h-16 rounded-lg flex items-center justify-center mb-6">
                  <mode.icon size={32} className="text-white" />
                </div>
                <h3 className="text-2xl font-bold text-gray-900 mb-3">{mode.title}</h3>
                <p className="text-gray-600 mb-4 leading-relaxed">{mode.desc}</p>
                <div className="bg-white rounded-lg p-3 border border-rose-200">
                  <p className="text-sm text-gray-700"><span className="font-semibold text-rose-700">Best for:</span> {mode.best}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-24 px-6 bg-gradient-to-b from-rose-50 via-white to-fuchsia-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Powerful Campaign Management</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div key={idx} className="bg-white/90 backdrop-blur rounded-2xl p-8 border border-rose-200 shadow-[0_20px_50px_rgba(244,63,94,0.16)] hover:-translate-y-1 hover:shadow-[0_30px_70px_rgba(217,70,239,0.25)] transition-all">
                <div className="bg-gradient-to-br from-rose-100 to-fuchsia-100 w-16 h-16 rounded-lg flex items-center justify-center mb-6 shadow-inner">
                  <feature.icon size={32} className="text-rose-900" />
                </div>
      ...
      {/* Use Cases */}
      <section className="py-24 px-6 bg-gradient-to-b from-white via-rose-50 to-white">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-4xl font-bold text-gray-900 mb-12 text-center">Perfect For Every Outbound Campaign</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              <div key={i} className="bg-white/90 backdrop-blur rounded-2xl p-6 border border-rose-200 shadow-[0_16px_40px_rgba(244,63,94,0.16)]">
                <h3 className="text-xl font-bold text-gray-900 mb-4">{useCase.title}</h3>
                <ul className="space-y-2">
                  {useCase.items.map((item, j) => (
                    <li key={j} className="flex items-center gap-2 text-gray-700">
                      <Check size={18} className="text-rose-700 flex-shrink-0" />
                      <span>{item}</span>
                    </li>
                  ))}
                </ul>
      ...
      {/* CTA */}
      <section className="py-24 px-6 bg-gradient-to-r from-rose-900 via-fuchsia-900 to-purple-900">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            <button className="bg-white text-rose-900 px-8 py-4 rounded-lg font-bold hover:bg-rose-50 transition-colors inline-flex items-center gap-2">
