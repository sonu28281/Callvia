        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={idx} className="bg-white/90 backdrop-blur rounded-2xl p-8 border border-fuchsia-200 shadow-[0_20px_50px_rgba(217,70,239,0.18)] hover:-translate-y-1 hover:shadow-[0_30px_70px_rgba(236,72,153,0.25)] transition-all">
                <div className="bg-fuchsia-800 w-16 h-16 rounded-lg flex items-center justify-center mb-6">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div key={idx} className="bg-white/90 backdrop-blur rounded-2xl p-8 border border-fuchsia-100/80 shadow-[0_20px_50px_rgba(217,70,239,0.18)] hover:-translate-y-1 hover:shadow-[0_30px_70px_rgba(236,72,153,0.25)] transition-all group">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={i} className="flex items-start gap-3">
                    <Check size={24} className="text-fuchsia-700 flex-shrink-0 mt-1" />
                    <span className="text-lg text-gray-900">{benefit}</span>
                  </div>
                ))}
              </div>
            </div>
            <div className="bg-gradient-to-br from-fuchsia-50 to-pink-50 rounded-2xl p-12 border border-fuchsia-200 shadow-[0_20px_60px_rgba(217,70,239,0.2)]">
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div key={i} className="flex gap-4">
                    <div className="bg-white rounded-lg p-3 h-fit border border-fuchsia-100">
                      <useCase.icon size={24} className="text-fuchsia-800" />
                    </div>
                    <div>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="bg-white/90 rounded-2xl shadow-[0_25px_70px_rgba(217,70,239,0.2)] p-12 border border-fuchsia-100">
            <div className="text-center mb-12">
              <Shield size={64} className="text-fuchsia-800 mx-auto mb-4" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                ...
                <div key={i} className="flex items-center gap-3 p-4 bg-fuchsia-50 rounded-lg">
                  <Check size={20} className="text-fuchsia-700 flex-shrink-0" />
