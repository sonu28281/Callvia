            ...
            {activeTabData.items.map((item, idx) => {
              ...
              return (
                <Link
                  ...
                  className="mega-menu-item p-5 rounded-lg border border-gray-200 bg-white no-underline transition-all duration-300 hover:border-cyan-400 hover:shadow-xl hover:bg-gradient-to-br hover:from-cyan-50 hover:to-blue-50 flex flex-col gap-3 group cursor-pointer"
                >
                  <div className="flex items-start gap-3">
                    <div className="p-3 rounded-lg bg-gradient-to-br from-blue-50 to-cyan-100 group-hover:from-cyan-100 group-hover:to-blue-100 transition-all duration-300 shadow-sm group-hover:shadow-md">
                      <IconComponent
                        size={24}
