...
export default function Careers() {
  ...
  return (
    <div className="bg-white">
      ...
      {/* Hero Section - Enterprise Callvia */}
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h1 className="text-5xl lg:text-6xl font-semibold leading-tight mb-6">
              ...
              <span className="text-slate-300"> mission-critical calling</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button className="bg-white text-slate-900 px-6 py-3 rounded-lg font-semibold flex items-center gap-2 hover:bg-slate-200 transition-colors">
          ...
          <div className="bg-slate-900/60 border border-slate-700 rounded-2xl p-6 shadow-2xl">
            <div className="flex items-center justify-between mb-6">
              <div>
                <div className="text-sm text-slate-400">Network Operations Console</div>
                <div className="text-lg font-semibold text-slate-100">Callvia Control Center</div>
              </div>
              <div className="text-xs text-slate-400">SLA: 99.99%</div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-slate-950 border border-slate-800 rounded-xl p-4">
                <div className="text-xs text-slate-500 mb-2">Routing Health</div>
                <div className="text-sm text-slate-200">Queue SLA: 99.6%</div>
              </div>
              <div className="bg-slate-950 border border-slate-800 rounded-xl p-4">
                <div className="text-xs text-slate-500 mb-2">Compliance</div>
                <div className="text-sm text-slate-200">Recording: 100%</div>
              </div>
            </div>
          </div>
        </div>
