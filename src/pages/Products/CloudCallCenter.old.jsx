  ...
  return (
    <div className="bg-white">
      <style>{`
        ...
        .text-shimmer {
          background: linear-gradient(90deg, #ffffff, #fde047, #ffffff);
        ...
        .headline-underline::after {
          ...
          height: 6px;
          border-radius: 999px;
          background: linear-gradient(90deg, rgba(244,114,182,0.6), rgba(168,85,247,0.6));
          filter: blur(0.5px);
        }
        .floating-particle {
          position: absolute;
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight slide-in-left" style={{animationDelay: '0.1s'}}>
                India-ready <span className="text-shimmer">Cloud Call Center</span>, Built to Scale
              </h1>
      ...
      {/* Stats Section */}
      <section className="py-16 px-6 bg-gradient-to-r from-fuchsia-900 via-purple-900 to-pink-900">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              <div key={i} className="text-center">
                ...
                <div className="text-fuchsia-200 text-sm">{stat.label}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* Features */}
      <section className="py-24 px-6 bg-gradient-to-b from-fuchsia-50 via-white to-pink-50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={idx}
                className="bg-white/90 backdrop-blur rounded-2xl p-8 border border-fuchsia-100/80 shadow-[0_20px_50px_rgba(217,70,239,0.18)] hover:-translate-y-1 hover:shadow-[0_30px_70px_rgba(236,72,153,0.25)] transition-all group"
              >
                <div className="bg-gradient-to-br from-fuchsia-100 to-pink-100 w-16 h-16 rounded-lg flex items-center justify-center mb-6 group-hover:scale-110 transition-transform shadow-inner">
                  <feature.icon size={32} className="text-fuchsia-900" />
                </div>
      ...
      {/* Use Cases */}
      <section className="py-24 px-6 bg-gradient-to-b from-white via-fuchsia-50 to-white">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-4xl font-bold text-gray-900 mb-12 text-center">
            Run Any Call Center Model with <span className="text-accent">Confidence</span>
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              ...
              <div key={i} className="bg-gradient-to-br from-fuchsia-50 to-white rounded-2xl p-8 border border-fuchsia-200 hover:-translate-y-1 hover:shadow-xl transition-all">
                <div className="w-14 h-14 rounded-2xl bg-white border border-fuchsia-100 flex items-center justify-center mb-4 shadow-sm">
                  <useCase.icon size={30} className="text-fuchsia-800" />
                </div>
                ...
                <ul className="space-y-2">
                  {useCase.features.map((feature, j) => (
                    <li key={j} className="flex items-center gap-2 text-gray-700">
                      <Check size={18} className="text-fuchsia-700 flex-shrink-0" />
                      <span>{feature}</span>
                    </li>
                  ))}
                </ul>
      ...
      {/* Pricing Hint */}
      <section className="py-24 px-6 bg-gradient-to-b from-slate-50 via-fuchsia-50 to-white">
        <div className="max-w-5xl mx-auto">
          <div className="bg-white/90 rounded-2xl shadow-[0_25px_70px_rgba(217,70,239,0.2)] p-12 border border-fuchsia-100">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-gray-900 mb-4">
                Pricing that <span className="text-accent">Scales</span> with Your Growth
              </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
              {[
                ...
                <div key={i} className={`p-6 rounded-lg border-2 ${i === 1 ? 'border-fuchsia-700 bg-fuchsia-50' : 'border-slate-200'}`}>
                  <h3 className="text-xl font-bold text-gray-900 mb-2">{tier.name}</h3>
                  <p className="text-gray-600 text-sm mb-4">{tier.agents}</p>
                  <p className="text-2xl font-bold text-fuchsia-800 mb-4">{tier.price}</p>
                  <button className={`w-full py-3 rounded-lg font-semibold ${i === 1 ? 'bg-fuchsia-800 text-white hover:bg-fuchsia-900' : 'bg-slate-200 text-gray-900 hover:bg-slate-300'} transition-colors`}>
                    Get Started
                  </button>
                </div>
              ))}
      ...
      {/* CTA */}
      <section className="py-24 px-6 bg-gradient-to-r from-fuchsia-900 via-purple-900 to-pink-900">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl font-bold text-white mb-6">
            Ready to <span className="text-shimmer">Modernize</span> Your Call Center?
          </h2>
          <p className="text-xl text-fuchsia-100 mb-8">
            Join 500+ call centers operating on Callvia's infrastructure
          </p>
          <div className="flex gap-4 justify-center flex-wrap">
            <button className="bg-white text-fuchsia-900 px-8 py-4 rounded-lg font-bold hover:bg-fuchsia-50 transition-colors inline-flex items-center gap-2">
              Book Demo <ArrowRight size={20} />
            </button>
            <button className="border-2 border-white text-white px-8 py-4 rounded-lg font-bold hover:bg-fuchsia-800 transition-colors">
              Contact Sales
            </button>
          </div>
        </div>
