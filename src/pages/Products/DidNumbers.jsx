...
export function DidNumbersPage() {
  return (
    <div className="bg-white">
              ...
              <div className="relative w-64 h-64">
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="bg-white/20 backdrop-blur-md rounded-full w-64 h-64 flex items-center justify-center shadow-2xl">
                    <Phone size={100} className="text-white icon-bounce drop-shadow-2xl" strokeWidth={1.5} />
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* CTA Section */}
      <section className="py-24 px-6 bg-gradient-to-r from-purple-900 to-purple-800">
